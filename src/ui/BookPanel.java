...
public class BookPanel extends JPanel {
    ...
    public BookPanel() {
        ...
        filterComboBox = new JComboBox<>(new String[]{"Title", "Author", "ISBN"});
        filterComboBox.setFont(new Font("Segoe UI", Font.PLAIN, 13));

        JButton searchButton = createButton("🔍 SEARCH BOOKS", new Color(0, 102, 204));
        ...
        addStyledField(inputPanel, "ISBN:", isbnField = new JTextField());
        addStyledField(inputPanel, "Title:", titleField = new JTextField());
        addStyledField(inputPanel, "Author:", authorField = new JTextField());

        JButton addButton = createButton("➕ ADD BOOK", new Color(46, 125, 50));
